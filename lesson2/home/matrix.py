...
class Matrix(object):
    ...
    def __add__(self, mat):
        ...
        addmat = Matrix(self.n, self.m)
        for i in range(self.n):
            for j in range(self.m):
                addmat[i][j] = self.array[i][j] + mat[i][j]
    ...
    def __sub__(self, mat):
        ...
        submat = Matrix(self.n, self.m)
        for i in range(self.n):
            for j in range(self.m):
                submat[i][j] = self.array[i][j] - mat[i][j]
    ...
    def dot(self, mat):
        ...
        dotmatr = Matrix(self.n, mat.m)
        for i in range(self.n):
            for j in range(mat.m):
                for k in range(mat.n):
                    dotmatr[i,j]+=self[i,k]*mat[k,j]
        return dotmatr
